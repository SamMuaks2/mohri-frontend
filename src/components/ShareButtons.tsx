  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <button
        ...
        className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-600 hover:bg-gray-700 transition-colors relative"
        title="Copy link"
      >
        {copied ? (
      ...
      {copied && (
        <span className="text-sm text-green-500 animate-fade-in">Copied!</span>
      )}
    </div>
  );
}